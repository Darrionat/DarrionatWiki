...
Enchantments can be added through the [Pickaxe GUI](broken-reference). Enchantments must all have a defined cost, slot of where they are displayed in the GUI, max level, and display information. Enchantments can also have other settings within the [enchants.yml](configuration-files/enchants.yml-1.0.2.md) depending on what they inherit. All enchantments have a minimum level of 1 and must have a unique name.
...
The custom enchantment of Jump Boost gives the potion effect [Jump Boost](https://minecraft.gamepedia.com/Jump\_Boost). This will change how fast the player can jump.
...
The custom enchantment of Night Vision will give the potion effect [Night Vision](https://minecraft.gamepedia.com/Night\_Vision). This will change how easily the player can see in the dark.&#x20;
